...
| `docs/claude-design-front-end-plan.md` | Phases, checklist, acceptance criteria |

---

*See also: [`docs/claude-design-front-end-plan.md`](claude-design-front-end-plan.md) for implementation phases.*
